...
module.exports = {
  ...
  getTask: (req, res) => {
    ...
    getId(req.params, (error, result) => {
      ...
      return SUCCESS(res, 201, true, 'Success create task', result)
    })
  },
  deleteTask: (req, res) => {
    payload = {
    ...
    deleteId(req.params, (error, result) => {
      ...
      return SUCCESS(res, 201, true, `Success delete task with id ${req.params.id}`, result)
    })
  },
  updateTask: (req, res) => {
    payload = {
    ...
    getId({
      ...
      update(data, (errors, results) => {
        ...
        return SUCCESS(res, 201, true, 'Success update task', results)
      })
    })
  },
  setBudget: (req, res) => {
    ...
    updateBudget({ id: req.body.id, idUser: req.decoded.user.id, budget: req.body.budget }, (error, result) => {
      ...
      return SUCCESS(res, 200, true, 'Success set budget', result)
    })
  },
}
